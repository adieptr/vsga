...
<div class="container text-center">
  ...
  <img src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?q=80&w=1474&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Lord Of The Rings</h5>
    <p class="card-text">Frodo, the young hobbit, inherits a ring with evil powers. Now, he must begin a dangerous journey to Mount Doom to destroy it.</p>
    <a href="#" class="btn btn-dark">Lihat Rak</a>
  </div>
</div>
